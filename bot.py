...
def bot(application: Application, data_path: str, prompt_path: str) -> None:
    ...
    application.add_handler(CommandHandler(COMMANDS['help'][0], help_handler))
    application.add_handler(CommandHandler(COMMANDS['create'][0], create))
    application.add_handler(CommandHandler(COMMANDS['tokens'][0], tokens))
    application.add_handler(CommandHandler(COMMANDS['suggest'][0], suggest))
    application.add_handler(CommandHandler(COMMANDS['generate'][0], generate))
    application.add_handler(CommandHandler(COMMANDS['bet'][0], bet))
    application.add_handler(CommandHandler(COMMANDS['close'][0], close))
